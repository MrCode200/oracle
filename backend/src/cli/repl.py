...
def repl():
    ...
    with Progress(
        ...
        logger.info("Initializing REPLv0.1...")
        ...
        from src.cli.commands import (change_status_command, clear_wallet_command,
                                      ...
                                      add_trading_component_command, remove_trading_component_command,
                                      list_profile_plugins_command,
                                      create_profile_command, update_profile_command,
                                      add_plugin_command, list_plugins_command, remove_plugin_command,
                                      update_plugin_command,
                                      list_profile_trading_component_command, update_trading_component_command,
                                      backtest_profile_command)
        ...
        trading_component_app.command(name="add", help="Adds an Trading Components to a profile.")(
            add_trading_component_command)
        trading_component_app.command(name="remove", help="Removes an Trading Components from a profile.")(
            remove_trading_component_command)
        trading_component_app.command(name="list", help="Lists all Trading Components of a profile.")(
            list_profile_trading_component_command)
        trading_component_app.command(name="update", help="Updates an Trading Components of a profile.")(
        ...
        logger.info("Finished initializing REPLv0.1...")
