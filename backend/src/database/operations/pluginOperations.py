...
def create_plugin(
    profile_id: int, plugin_name: str, plugin_settings: dict
) -> Plugin | None:
    """
    ...
    try:
        ...
        logger.info(
            f"Plugin {plugin_name} created successfully for profile {profile_id}."
        )
        return new_plugin
...
def update_plugin(
    plugin_id: int, plugin_name: str | None = None, plugin_settings: dict | None = None
) -> bool:
    """
