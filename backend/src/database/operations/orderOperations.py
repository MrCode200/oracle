...
def create_order(profile_id: int, type: str, ticker: str, quantity: int, price: float) -> Order:
    """
    ...
    try:
        ...
        logger.info(f"Order for {ticker} created successfully for profile {profile_id}.")
        return new_order
...
def get_order(order_id: int = None, profile_id: int = None, ticker: str = None) -> Order | list[Type[Order]] | None:
    """
